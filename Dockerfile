...
ARG CROWNLINE_VERSION=development
ARG CROWNLINE_REVISION=unknown
ARG CROWNLINE_SOURCE_URL=unknown
LABEL org.opencontainers.image.title="Crownlines server" \
    org.opencontainers.image.description="Authoritative private-room Crownlines match server" \
    org.opencontainers.image.version="${CROWNLINE_VERSION}" \
    org.opencontainers.image.revision="${CROWNLINE_REVISION}" \
    org.opencontainers.image.source="${CROWNLINE_SOURCE_URL}" \
